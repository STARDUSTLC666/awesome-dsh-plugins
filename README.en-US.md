...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-09-05 01:01（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 68913 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 6856 | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem… |
...
| 7 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1365 | AgentTeams plugin for DeepSeek Harness |
| 8 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 1069 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
...
| 16 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 403 | GenUI for DeepSeek Harness: interactive UI components r… |
| 17 | [Abu-Cowork](https://github.com/PM-Shawn/Abu-Cowork) | 366 | Open-source alternative to Claude Cowork — a local-firs… |
| 18 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 328 | Composable three-tier memory control plane for DeepSeek… |
