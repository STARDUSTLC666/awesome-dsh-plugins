...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-09-06 04:28（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 69025 | Compress tool outputs, logs, files, and RAG chunks befo… |
...
| 7 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1387 | AgentTeams plugin for DeepSeek Harness |
...
| 18 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 334 | Composable three-tier memory control plane for DeepSeek… |
