...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-30 06:40（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 68007 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 6453 | DeepSeek Harness（DSH）Web 插件聚合生态包 · 一切皆插件，创意工坊分发 |
...
| 6 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1456 | Local-first AI token usage & cost tracker for 31 coding… |
| 7 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1188 | AgentTeams plugin for DeepSeek Harness |
...
| 16 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 366 | GenUI for DeepSeek Harness: interactive UI components r… |
