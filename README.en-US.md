...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-26 14:03（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 67611 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 6096 | DeepSeek Harness（DSH）Web 插件聚合生态包 · 一切皆插件，创意工坊分发 |
| 3 | [modlens](https://github.com/liustack/modlens) | 3671 | The first vision plugin for DeepSeek Harness, and the v… |
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2924 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2562 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
| 6 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1425 | Local-first AI token usage & cost tracker for 31 coding… |
| 7 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1028 | AgentTeams plugin for DeepSeek Harness |
| 8 | [PicGo-Core](https://github.com/PicGo/PicGo-Core) | 982 | :zap:The ultimate image uploading engine. Both CLI & AP… |
| 9 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 979 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
| 10 | [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 827 | [dsh]为纯文本模型设计更强大的视觉工具箱：一行安装使用、粘贴图片直接识别、多张图片问答、截图到前端UI 还… |
...
| 13 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 568 | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups … |
| 14 | [dsh-at-file](https://github.com/FSMargoo/dsh-at-file) | 475 | Codex-style @file mentions for DeepSeek Harness: search… |
| 15 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 459 | Chrome sidebar extension that lets DeepSeek Harness ope… |
| 16 | [Abu-Cowork](https://github.com/PM-Shawn/Abu-Cowork) | 349 | Open-source alternative to Claude Cowork — a local-firs… |
| 17 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 338 | GenUI for DeepSeek Harness: interactive UI components r… |
| 18 | [Bigfish](https://github.com/turtle2209/Bigfish) | 302 | Bigfish —— DeepSeek Harness 的第三方桌面端，内置 Node 运行时，双击即用，附带… |
| 19 | [whale-girl](https://github.com/vlln/whale-girl) | 285 | DSH Web GUI 桌面宠物插件（QQ 宠物形态）：右下角悬浮、可拖拽/投喂/玩耍的积累型伙伴。 |
| 20 | [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 279 | 一套 DSH runtime，Desktop、Web 与 TUI 三种开发体验。 |
