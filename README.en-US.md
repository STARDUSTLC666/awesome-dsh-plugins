...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-23 19:12（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 67236 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 5679 | DeepSeek Harness（DSH）Web GUI 插件与皮肤生态：一切皆插件。任务看板、移动端远程与 … |
...
| 8 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 939 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
| 9 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 866 | AgentTeams plugin for DeepSeek Harness |
| 10 | [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 811 | [dsh]为纯文本模型设计更强大的视觉工具箱：安装免费使用、粘贴图片直接识别、多张图片问答、截图到前端UI 还… |
