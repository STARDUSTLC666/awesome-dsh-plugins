...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-09-10 07:28（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 71078 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 7242 | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem… |
...
| 7 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1489 | AgentTeams plugin for DeepSeek Harness |
...
| 13 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 611 | Chrome sidebar extension that lets DeepSeek Harness ope… |
