...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-09-06 09:54（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 69042 | Compress tool outputs, logs, files, and RAG chunks befo… |
...
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2850 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
| 6 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1522 | Local-first AI token usage & cost tracker for 31 coding… |
| 7 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1388 | AgentTeams plugin for DeepSeek Harness |
...
| 18 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 336 | Composable three-tier memory control plane for DeepSeek… |
