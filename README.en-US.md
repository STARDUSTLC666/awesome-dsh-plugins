...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-22 19:53（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 67159 | Compress tool outputs, logs, files, and RAG chunks befo… |
...
| 10 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 787 | AgentTeams plugin for DeepSeek Harness |
...
| 13 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 534 | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups … |
| 14 | [dsh-at-file](https://github.com/FSMargoo/dsh-at-file) | 454 | Codex-style @file mentions for DeepSeek Harness: search… |
| 15 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 386 | dsh plugin: Chrome sidebar extension that lets DeepSeek… |
