...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-30 19:56（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 68063 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 6490 | DeepSeek Harness（DSH）Web 插件聚合生态包 · 一切皆插件，创意工坊分发 |
| 3 | [modlens](https://github.com/liustack/modlens) | 3767 | The first vision plugin for DeepSeek Harness, and the v… |
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3116 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2703 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
| 6 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1459 | Local-first AI token usage & cost tracker for 31 coding… |
| 7 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1193 | AgentTeams plugin for DeepSeek Harness |
...
| 13 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 588 | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups … |
| 14 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 526 | Chrome sidebar extension that lets DeepSeek Harness ope… |
| 15 | [dsh-at-file](https://github.com/FSMargoo/dsh-at-file) | 498 | Codex-style @file mentions for DeepSeek Harness: search… |
| 16 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 371 | GenUI for DeepSeek Harness: interactive UI components r… |
...
| 20 | [oh-dsh](https://github.com/hust-open-atom-club/oh-dsh) | 293 | 一套 DSH runtime，Desktop、Web 与 TUI 三种开发体验。 |
