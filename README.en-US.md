...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-09-18 07:15（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 72772 | Compress tool outputs, logs, files, and RAG chunks befo… |
...
| 7 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1649 | Local-first AI token usage & cost tracker for 31 coding… |
...
| 11 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 677 | Chrome sidebar extension that lets DeepSeek Harness ope… |
