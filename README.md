...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-09-26 05:36（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 73811 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 8015 | DeepSeek Harness (DSH) Web 插件聚合生态 · 万物皆插件，通过创意工坊分发｜｜Dee… |
| 3 | [modlens](https://github.com/liustack/modlens) | 4038 | The first vision plugin for DeepSeek Harness, and the v… |
...
| 7 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1723 | Local-first AI token usage & cost tracker for 31 coding… |
...
| 16 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 480 | GenUI for DeepSeek Harness: interactive UI components r… |
