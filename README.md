...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-09-23 09:30（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 73533 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 7943 | DeepSeek Harness (DSH) Web 插件聚合生态 · 万物皆插件，通过创意工坊分发｜｜Dee… |
| 3 | [modlens](https://github.com/liustack/modlens) | 4016 | The first vision plugin for DeepSeek Harness, and the v… |
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3717 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 3154 | DSH 官方公众号收录的 TUI 补位插件：鲸鱼顶栏/实时状态/流式思考/双击 Esc 回滚/上下文进度+TP… |
| 6 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1773 | AgentTeams plugin for DeepSeek Harness |
| 7 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1701 | Local-first AI token usage & cost tracker for 31 coding… |
...
| 9 | [PicGo-Core](https://github.com/PicGo/PicGo-Core) | 988 | :zap:The ultimate image uploading engine. Both CLI & AP… |
...
| 11 | [dsh-browser](https://github.com/omdsh-dev/dsh-browser) | 718 | Chrome sidebar extension that lets DeepSeek Harness ope… |
...
| 13 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 632 | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups … |
...
| 17 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 395 | Composable, view-based memory for DeepSeek Harness. Plu… |
...
| 20 | [dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve) | 327 | 为 DeepSeek Harness 带来「跨会话长期记忆 + 后台自我进化」能力的纯插件实现：五轨记忆 · … |
