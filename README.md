...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-09-21 08:17（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 73264 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 7861 | DeepSeek Harness (DSH) Web 插件聚合生态 · 万物皆插件，通过创意工坊分发｜｜Dee… |
...
| 6 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1748 | AgentTeams plugin for DeepSeek Harness |
| 7 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1679 | Local-first AI token usage & cost tracker for 31 coding… |
