...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-23 15:49（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 67227 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 5638 | DeepSeek Harness（DSH）Web GUI 插件与皮肤生态：一切皆插件。梁神模式、任务看板、移动… |
| 3 | [modlens](https://github.com/liustack/modlens) | 3537 | The first vision plugin for DeepSeek Harness, and the v… |
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2684 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2335 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
...
| 9 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 854 | AgentTeams plugin for DeepSeek Harness |
...
| 15 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 397 | dsh plugin: Chrome sidebar extension that lets DeepSeek… |
| 16 | [Abu-Cowork](https://github.com/PM-Shawn/Abu-Cowork) | 343 | Open-source alternative to Claude Cowork — a local-firs… |
| 17 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 299 | GenUI for DeepSeek Harness: interactive UI components r… |
