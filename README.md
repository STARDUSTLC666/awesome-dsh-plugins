...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-09-08 07:09（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 70044 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 7104 | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem… |
| 3 | [modlens](https://github.com/liustack/modlens) | 3910 | The first vision plugin for DeepSeek Harness, and the v… |
...
| 7 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1433 | AgentTeams plugin for DeepSeek Harness |
...
| 10 | [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 857 | [dsh]为纯文本模型设计更强大的视觉工具箱：一行安装使用、粘贴图片直接识别、多张图片问答、截图到前端UI 还… |
