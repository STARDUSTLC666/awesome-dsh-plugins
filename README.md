...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-31 02:55（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 68098 | Compress tool outputs, logs, files, and RAG chunks befo… |
...
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3126 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
...
| 7 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1201 | AgentTeams plugin for DeepSeek Harness |
...
| 11 | [sandbase-harness](https://github.com/sandbaseai/sandbase-harness) | 638 | Local-first, self-hosted AI agent runtime with MCP tool… |
| 12 | [dsh-desktop](https://github.com/vibeinging/dsh-desktop) | 635 | DeepSeek Harness Desktop App: a local AI desktop worksp… |
| 13 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 590 | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups … |
