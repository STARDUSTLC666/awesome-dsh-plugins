...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-23 17:46（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 67231 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 5664 | DeepSeek Harness（DSH）Web GUI 插件与皮肤生态：一切皆插件。梁神模式、任务看板、移动… |
...
| 9 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 859 | AgentTeams plugin for DeepSeek Harness |
...
| 13 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 545 | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups … |
