...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-26 03:58（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 67561 | Compress tool outputs, logs, files, and RAG chunks befo… |
...
| 7 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1007 | AgentTeams plugin for DeepSeek Harness |
...
| 15 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 455 | Chrome sidebar extension that lets DeepSeek Harness ope… |
