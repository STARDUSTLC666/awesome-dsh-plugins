...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-09-13 04:53（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 71737 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 7468 | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem… |
| 3 | [modlens](https://github.com/liustack/modlens) | 3955 | The first vision plugin for DeepSeek Harness, and the v… |
...
| 7 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1588 | AgentTeams plugin for DeepSeek Harness |
...
| 12 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 636 | Chrome sidebar extension that lets DeepSeek Harness ope… |
