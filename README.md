...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-09-06 14:39（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 69056 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 6963 | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem… |
| 3 | [modlens](https://github.com/liustack/modlens) | 3879 | The first vision plugin for DeepSeek Harness, and the v… |
...
| 6 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1523 | Local-first AI token usage & cost tracker for 31 coding… |
| 7 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1393 | AgentTeams plugin for DeepSeek Harness |
| 8 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 1073 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
...
| 18 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 338 | Composable, view-based memory for DeepSeek Harness. Plu… |
