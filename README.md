...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-09-14 23:02（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 72056 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 7558 | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem… |
| 3 | [modlens](https://github.com/liustack/modlens) | 3962 | The first vision plugin for DeepSeek Harness, and the v… |
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3594 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 3031 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
| 6 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1634 | AgentTeams plugin for DeepSeek Harness |
| 7 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1606 | Local-first AI token usage & cost tracker for 31 coding… |
| 8 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 1099 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
...
| 11 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 648 | Chrome sidebar extension that lets DeepSeek Harness ope… |
| 12 | [sandbase-harness](https://github.com/sandbaseai/sandbase-harness) | 645 | Local-first, self-hosted AI agent runtime and MCP bridg… |
| 13 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 624 | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups … |
...
| 16 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 450 | GenUI for DeepSeek Harness: interactive UI components r… |
| 17 | [Abu-Cowork](https://github.com/PM-Shawn/Abu-Cowork) | 374 | Open-source alternative to Claude Cowork — a local-firs… |
| 18 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 369 | Composable, view-based memory for DeepSeek Harness. Plu… |
