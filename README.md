...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-09-01 14:58（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 68242 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 6622 | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem… |
| 3 | [modlens](https://github.com/liustack/modlens) | 3811 | The first vision plugin for DeepSeek Harness, and the v… |
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3194 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2756 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
| 6 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1482 | Local-first AI token usage & cost tracker for 31 coding… |
| 7 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1240 | AgentTeams plugin for DeepSeek Harness |
| 8 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 1041 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
| 9 | [PicGo-Core](https://github.com/PicGo/PicGo-Core) | 982 | :zap:The ultimate image uploading engine. Both CLI & AP… |
| 10 | [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 846 | [dsh]为纯文本模型设计更强大的视觉工具箱：一行安装使用、粘贴图片直接识别、多张图片问答、截图到前端UI 还… |
...
| 13 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 596 | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups … |
| 14 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 542 | Chrome sidebar extension that lets DeepSeek Harness ope… |
| 15 | [dsh-at-file](https://github.com/FSMargoo/dsh-at-file) | 500 | Codex-style @file mentions for DeepSeek Harness: search… |
| 16 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 384 | GenUI for DeepSeek Harness: interactive UI components r… |
...
| 19 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 305 | Composable three-tier memory control plane for DeepSeek… |
