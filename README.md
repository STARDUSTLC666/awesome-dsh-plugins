...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-18 03:43（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 66651 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 4084 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
| 3 | [modlens](https://github.com/liustack/modlens) | 2777 | The first vision plugin for DeepSeek Harness, and the v… |
...
| 8 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 629 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
...
| 10 | [sandbase-harness](https://github.com/sandbaseai/sandbase-harness) | 614 | Open-source CMA-compatible agent runtime for any model,… |
...
| 17 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 251 | dsh plugin: Chrome sidebar extension that lets DeepSeek… |
