...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-09-07 05:22（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 69133 | Compress tool outputs, logs, files, and RAG chunks befo… |
...
| 7 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 1410 | AgentTeams plugin for DeepSeek Harness |
...
| 16 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 412 | GenUI for DeepSeek Harness: interactive UI components r… |
