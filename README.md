...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-09-04 01:34（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 68787 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 6786 | DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem… |
| 3 | [modlens](https://github.com/liustack/modlens) | 3853 | The first vision plugin for DeepSeek Harness, and the v… |
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3298 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2812 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
| 6 | [TokenTracker](https://github.com/xiufengsun/TokenTracker) | 1509 | Local-first AI token usage & cost tracker for 31 coding… |
...
| 14 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 563 | Chrome sidebar extension that lets DeepSeek Harness ope… |
| 15 | [dsh-at-file](https://github.com/FSMargoo/dsh-at-file) | 504 | Codex-style @file mentions for DeepSeek Harness: search… |
| 16 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 398 | GenUI for DeepSeek Harness: interactive UI components r… |
| 17 | [Abu-Cowork](https://github.com/PM-Shawn/Abu-Cowork) | 365 | Open-source alternative to Claude Cowork — a local-firs… |
| 18 | [dsh-mnemon](https://github.com/omdsh-dev/dsh-mnemon) | 319 | Composable three-tier memory control plane for DeepSeek… |
