...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-19 07:12（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 66788 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 4567 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
| 3 | [modlens](https://github.com/liustack/modlens) | 3096 | The first vision plugin for DeepSeek Harness, and the v… |
...
| 8 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 756 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
...
| 13 | [deepseek-harness-desktop-app](https://github.com/vibeinging/deepseek-harness-desktop-app) | 395 | DeepSeek Harness Desktop App: a local AI desktop worksp… |
...
| 16 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 298 | dsh plugin: Chrome sidebar extension that lets DeepSeek… |
