...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-31 08:01（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 68110 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web](https://github.com/zhu1090093659/dsh-web) | 6515 | DeepSeek Harness（DSH）Web 插件聚合生态包 · 一切皆插件，创意工坊分发 |
| 3 | [modlens](https://github.com/liustack/modlens) | 3775 | The first vision plugin for DeepSeek Harness, and the v… |
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 3128 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/侧边对话/Git/子代理页面 ｜ Op… |
...
| 8 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 1032 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
...
| 14 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 531 | Chrome sidebar extension that lets DeepSeek Harness ope… |
...
| 18 | [Bigfish](https://github.com/turtle2209/Bigfish) | 304 | Bigfish —— DeepSeek Harness 的第三方桌面端，内置 Node 运行时，双击即用，附带… |
| 19 | [whale-girl](https://github.com/vlln/whale-girl) | 300 | DSH Web GUI 桌面宠物插件（QQ 宠物形态）：右下角悬浮、可拖拽/投喂/玩耍的积累型伙伴。 |
