...
> 按 GitHub star 数排序，每 20 分钟自动刷新。数据截至 2026-08-19 15:23（UTC+8）。

| # | 插件 | ⭐ | 说明 |
|---|---|---|---|
| 1 | [headroom](https://github.com/headroomlabs-ai/headroom) | 66828 | Compress tool outputs, logs, files, and RAG chunks befo… |
| 2 | [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) | 4723 | Plugin and skin collection for DeepSeek Harness (DSH) W… |
| 3 | [modlens](https://github.com/liustack/modlens) | 3177 | The first vision plugin for DeepSeek Harness, and the v… |
| 4 | [DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | 2246 | 开放的侧边栏底座，支持三方拓展注册新侧边栏页面。内置文件渲染编辑/终端/Git/子代理页面 ｜ Open si… |
| 5 | [dsh-TUI](https://github.com/ccch1mneyyy/dsh-TUI) | 2021 | DSH 官方公众号收录的 TUI 补位插件：Claude Code 风，鲸鱼顶栏/实时状态/流式思考/双击 E… |
...
| 8 | [dsh-vision-router](https://github.com/ysr666/dsh-vision-router) | 784 | Eyes for text-only DeepSeek Harness agents: built-in fr… |
| 9 | [dsh-vision-toolkit](https://github.com/Anionex/dsh-vision-toolkit) | 720 | [dsh]为纯文本模型设计更强大的视觉工具箱：安装免费使用、粘贴图片直接识别、多张图片问答、截图到前端UI 还… |
...
| 11 | [dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams) | 584 | AgentTeams plugin for DeepSeek Harness |
| 12 | [dsh-ads](https://github.com/Nagi-ovo/dsh-ads) | 505 | 把 DSH 变成 2005 年门户网站｜Parody ads, fake games, and popups … |
...
| 14 | [dsh-at-file](https://github.com/omdsh-dev/dsh-at-file) | 399 | Codex-style @file mentions for DeepSeek Harness: search… |
| 15 | [Abu-Cowork](https://github.com/PM-Shawn/Abu-Cowork) | 337 | Open-source alternative to Claude Cowork — a local-firs… |
| 16 | [dsh-browser](https://github.com/Lum1104/dsh-browser) | 308 | dsh plugin: Chrome sidebar extension that lets DeepSeek… |
| 17 | [Bigfish](https://github.com/turtle2209/Bigfish) | 273 | Bigfish —— DeepSeek Harness 的第三方桌面端，内置 Node 运行时，双击即用，附带… |
...
| 20 | [dsh-genui](https://github.com/omdsh-dev/dsh-genui) | 228 | GenUI for DeepSeek Harness: interactive UI components r… |
