...
| 插件 | 仓库 | 说明 | 运行级 |
|---|---|---|---|
| dsh-suite | [STARDUSTLC666/dsh-suite](https://github.com/STARDUSTLC666/dsh-suite) | 插件全家桶·组合补丁：一条 add 命令装齐 18 个 STARDUSTLC 插件（办公流/媒体工坊/DevOps/做梦）并统一注入默认配置，扁平化设计兼容 pnpm 11，2026-08-27 同载启动 + 消费者安装双验证 | ✅ |
